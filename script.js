...
document.querySelectorAll('#draw span')[0].textContent = player1Count;
document.querySelectorAll('#draw span')[1].textContent = drawCount;
document.querySelectorAll('#draw span')[2].textContent = player2Count;
...
function resetCount() {
  ...
  document.querySelectorAll('#draw span')[0].textContent = 0;
  document.querySelectorAll('#draw span')[1].textContent = 0;
  document.querySelectorAll('#draw span')[2].textContent = 0;
  //  reloadPage();
}